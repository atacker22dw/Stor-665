...
# Maybe look into a confusion matrix for predictive accurary.  shouldnt be the biggest deal since we are testing benign vs malignant not holistically healthy vs cancer, but still a good metric.
